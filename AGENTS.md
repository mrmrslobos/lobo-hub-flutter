...
Huddle (LoboHub) is a Flutter mobile/web app for family management (tasks, meals, budget, calendar, 18+ modules). Backend is Supabase (PostgreSQL, Auth, Edge Functions). See `README.md` for web deployment details.
